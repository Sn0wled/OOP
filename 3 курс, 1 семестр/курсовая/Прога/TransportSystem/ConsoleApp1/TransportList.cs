...
class TransportList : IEnumerable
{
    List<Transport> transports = new();
    int counter = 0;
    public int Length {  get { return counter; } }

    public IEnumerator GetEnumerator() { return transports.GetEnumerator(); }
    ...
    public void DeleteTransport(Transport t) => transports.Remove(t);
